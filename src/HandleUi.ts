...
export function addPokemonToPreviewBox(pokemon: Pokemon) {
    ...
    function spinShiny() {
        ...
        let pokeImgRegularFront = pokemon.spritesSources.frontDefault;
        let pokeImgRegularBack = pokemon.spritesSources.backDefault;
        let pokeImgShinyFront = pokemon.spritesSources.frontShiny;
        let pokeImgShinyBack = pokemon.spritesSources.backShiny;
